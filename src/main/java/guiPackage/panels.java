...
public class panels {
	...
	static void Menu() {
		String [] messageStrings = {"Single File Upload","--SELECT--","Bulk File Type Upload","Manual Entry"};
      			...
      			if(e.getSource()==cmbMessageList) {
      				...
      				case"Single File Upload": lblText.setText("You Selected:"+msg);button.addMouseListener((MouseListener) new MouseAdapter() {
                    	  ...
                    	  public void mouseClicked(MouseEvent e) {
                    		  ...
                    		  frame.remove(button);
             		       frame.remove(cmbMessageList);
               		       frame.add(TabbedPaneEnableDisableTab.showFrame());
               		       frame.revalidate();
        	  ...
        	  x.addMouseListener((MouseListener) new MouseAdapter() {
            	  ...
            	  public void mouseClicked(MouseEvent e) {
            		 ...
            		 frame.revalidate();
          			...
          			button.setBounds(150,250,100,60);
          			button.setText("GO");
          			...
          			cmbMessageList.setBounds(250,250,150,50);
